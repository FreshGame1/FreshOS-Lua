...
do
	local success, result = pcall(component.internet.request, "https://raw.githubusercontent.com/FreshGame1/FreshOS-Lua/master/Installer/Main.lua")
...
component.eeprom.set([[
	local connection, data, chunk = component.proxy(component.list("internet")()).request("https://raw.githubusercontent.com/FreshGame1/FreshOS-Lua/master/Installer/Main.lua"), ""
